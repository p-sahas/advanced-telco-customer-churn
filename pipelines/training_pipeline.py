...
from model_building import LogisticRegressionModelBuilder, DecisionTreeModelBuilder, XGBoostModelBuilder
...
def training_pipeline(
    ...
    run = mlflow_tracker.start_run(run_name='training_pipeliine', tags=run_tags)
    ...
    model_builder = XGBoostModelBuilder(**model_params) #LogisticRegressionModelBuilder, DecisionTreeModelBuilder,
